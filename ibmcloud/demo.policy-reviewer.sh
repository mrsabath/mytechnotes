...
syntax:
   $0 [pod-to-inspect] [namespace] [constraints] [secret-name] [local-path]

where:
      [pod-to-inspect] - name of the application pod to inject the secret
      [namespace]   - namespace of the application pod
      [constraints] - "region" or "region,images" or "region,cluster-name,namespace,images"
      [secret-name] - name of the secret to be injected
      [local-path]  - location of the secret in the pod


The the complate list of options, please visit:
